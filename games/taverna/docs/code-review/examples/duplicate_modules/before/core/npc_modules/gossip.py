"""
NPC Gossip System - DUPLICATE in npc_modules directory

⚠️ WARNING: This is a DUPLICATE of core/npc_systems/gossip.py
This is a simplified example showing the duplication issue.
In the actual codebase, this file contains 638 lines.
"""
