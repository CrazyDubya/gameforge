"""
Player Manager Module - Inadequate Test Coverage

This module demonstrates code with insufficient test coverage (50%).
Only the happy path is tested, leaving edge cases and error paths uncovered.

Status: 🔴 LOW COVERAGE - Needs more tests
"""
